...
Template only: sample facts and completion states are not verified; retain only requested sections and replace examples with actual evidence or explicit unknowns.
